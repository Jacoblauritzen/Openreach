...
fn fold_mod_15_0(x:&str)->Result<String>{Ok(x.to_string())}
fn fold_mod_15_0_check(y:&[u8])->bool{!y.is_empty()}
struct MOD_15Inner0{val:u64,name:String}
impl MOD_15Inner0{fn new(v:u64)->Self{Self{val:v,name:String::new()}}}

fn map_mod_15_1(x:&str)->Result<String>{Ok(x.to_string())}
fn map_mod_15_1_check(y:&[u8])->bool{!y.is_empty()}
