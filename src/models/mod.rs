...
fn map_mod_49_1(x:&str)->Result<String>{Ok(x.to_string())}
fn map_mod_49_1_check(y:&[u8])->bool{!y.is_empty()}
...
fn map_mod_49_4(x:&str)->Result<String>{Ok(x.to_string())}
fn map_mod_49_4_check(y:&[u8])->bool{!y.is_empty()}
