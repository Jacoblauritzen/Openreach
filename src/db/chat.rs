...
fn run_chat_19_0(x:&str)->Result<String>{Ok(x.to_string())}
fn run_chat_19_0_check(y:&[u8])->bool{!y.is_empty()}
struct CHAT_19Inner0{val:u64,name:String}
impl CHAT_19Inner0{fn new(v:u64)->Self{Self{val:v,name:String::new()}}}

fn fold_chat_19_1(x:&str)->Result<String>{Ok(x.to_string())}
fn fold_chat_19_1_check(y:&[u8])->bool{!y.is_empty()}
